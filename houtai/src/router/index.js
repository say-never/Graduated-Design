...
const staticRoutes = [
	...
	{
		path: '/timuxinxi/tinymceEditor/:id',
		name: 'tinymceEditor',
		component: () => import('@/views/timuxinxi/tinymceEditor.vue'),
		meta: {
			title: 'message.staticRoutes.tinymceEditor',
		},
	},
	{
		path: '/xinwentongzhi/tinymceEditor/:id',
		name: 'tinymceEditor',
		component: () => import('@/views/xinwentongzhi/tinymceEditor.vue'),
		meta: {
			title: 'message.staticRoutes.tinymceEditor',
		},
	},
...
export function putongyonghuUser(router, to, next) {
	resetRouter();
	menuApi
		.getMenuPutongyonghu()
		.then(async (res) => {
...
export function getRouterList(router, to, next) {
	...
	if (Session.get('userInfo').roles[0] === 'putongyonghu') putongyonghuUser(router, to, next);
